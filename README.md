...
- **Works without any API key.** 2,048 exercises (919 vocabulary items with article, plural, example and Serbian gloss), rule-based feedback on free writing, self-check rubrics with model answers, browser speech (TTS/STT).
